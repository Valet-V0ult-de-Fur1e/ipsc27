  ...
  const textArray = [
    ...
    <div>
        ...
        <dev>
            ...
            <li><a href="http://ipsc.ru" target="_blank" rel="noreferrer">Соглашение</a> на обработку своих персональных данных;</li>
            <li><a href="http://ipsc.ru">Анкета для вступления</a>.</li>
        </dev>
    </div>,
    <div>
      <h4>Зарегистрируйся на <a href="http://ipsc.ru" target="_blank" rel="noreferrer">ipsc.ru</a> и оплати вступительный и ежегодный взносы</h4>
      <h5>Вступительный взнос: 2000 рублей</h5>
      <h5>Ежегодный взнос: 3000 рублей — за 1 год, либо 12000 рублей — за 5 лет</h5>
      <h5>Подробнее о взносах можно узнать на <a href="http://ipsc.ru" target="_blank" rel="noreferrer">ipsc.ru</a></h5>
    </div>, 
    <div>
